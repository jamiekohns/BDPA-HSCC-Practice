...
if(isset($_POST['submit'])){
    ...
    $ticket_info = $ticket->get_ticket_by_confirmatiomn_id($_POST['name'], $_POST['ticket']);
    if($ticket_info == NULL){
        $message = 'This is an invalid name or ticket id. Please try again with a valid name and ticket id';
    } else {
        $message = NULL;
    }
...
<div class="container">
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0">Search For Tickets</h6>
        <form action="ticket.php" method="post" class="needs-validation" novalidate>
            <div class="form-row">
