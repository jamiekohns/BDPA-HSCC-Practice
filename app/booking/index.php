...
if(isset($_POST['submit'])){
    ...
    $_POST['booking_card_name'], $user['first_name'] ?? null, $user['last_name'] ?? null,
...
<div class="container">
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <form action="index.php?flight_id=<?=$flight_id?>" method="post" class="needs-validation" novalidate>
            <div class="form-row">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="custom-control custom-radio">
                        <div class="custom-control custom-radio">
                            <input type="radio" id="one" name="CarryOn" value="1" class="custom-control-input" checked>
                            <label class="custom-control-label" for="one">One Bag</label>
                        </div>

                        <div class="custom-control custom-radio">
                            <input type="radio" id="two" name="CarryOn" value="2" class="custom-control-input">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="custom-control custom-radio">
                        <div class="custom-control custom-radio">
                            <input type="radio" id="Checkone" name="CheckIn" value="1" class="custom-control-input" checked>
                            <label class="custom-control-label" for="Checkone">One Bag</label>
                        </div>

                        <div class="custom-control custom-radio">
                            <input type="radio" id="Checktwo" name="CheckIn" value="2" class="custom-control-input">
                            <label class="custom-control-label" for="Checktwo">Two Bags</label>
                        </div>

                        <div class="custom-control custom-radio">
                            <input type="radio" id="three" name="CheckIn" value="3" class="custom-control-input">
                            <label class="custom-control-label" for="three">Three Bags</label>
                        </div>

                        <div class="custom-control custom-radio">
                            <input type="radio" id="four" name="CheckIn" value="4" class="custom-control-input">
                            <label class="custom-control-label" for="four">Four Bags</label>
                        </div>

                        <div class="custom-control custom-radio">
                            <input type="radio" id="five" name="CheckIn" value="5" class="custom-control-input">
            ...
            $map = seatMap();
            $soldSeats = (new Tickets())->getSoldSeats($flight_id);
        ...
        <div>
        <h6 class="my-0">Carry on Bags</h6>
...
<li class="list-group-item d-flex justify-content-between lh-condensed">
<div>
<h6 class="my-0">Checked in Bags</h6>
<small class="text-muted">Brief description</small>
</div>
...
<div class="col-md-8 order-md-1">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            <label for="city">City</label>
            <input type="text" class="form-control" id="booking_city" placeholder="" name="booking_city" required>
            <div class="invalid-feedback">
                City required.
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3 mb-3">
            ...
            <input type="date" class="form-control" id="expiration_date" placeholder="" name="booking_card_expiration" required>
            <div class="invalid-feedback">
